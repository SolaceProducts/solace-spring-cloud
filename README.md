[![Actions Status](https://github.com/SolaceDev/solace-spring-cloud/workflows/build/badge.svg?branch=master)](https://github.com/SolaceDev/solace-spring-cloud/actions?query=workflow%3Abuild+branch%3Amaster)
