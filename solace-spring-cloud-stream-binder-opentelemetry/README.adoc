...
See link:{docdir}/solace-spring-cloud-stream-binder-instrumentation-tests/[integration tests] for an example of trace data generated by this instrumentation.
